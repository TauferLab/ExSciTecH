	...
	<body onload="init();">
		...
		<div class="container" id="contentWrapper">
			<div id="gameWrapper" class="well well-sm">
				<div id="startUI">
				    <div class="row">
                        <div class="col-md-2"><button onClick="window.history.back()" class="btn btn-success"><span class="glyphicon glyphicon-chevron-left"></span> Back</button></div>
                    </div>
                    <div class="row">
                        <div class="col-md-12"><h1 id="qSetTitle"></h1></div>
                    </div>
                    <div class="row">
                        <div class="col-md-8" style="font-size: 1.5em">
                            
                            <label for="infoNum" class="col-lg-3 control-label">Questions:</label>
                            <p class="col-lg-9" id="infoNum"></p>
                            <label for="infoTime" class="col-lg-3 control-label">Time Limit:</label>
                            <p class="col-lg-9" id="infoTime"></p>
                            <label for="infoDesc" class="col-lg-3 control-label">Description:</label>
                            <p class="col-lg-9" id="infoDesc"></div>
                        <div class="col-md-4">
                            <h2 style="text-align: center; color: rgb(85, 85, 85); margin-top:0px;">High Scores</h2>
