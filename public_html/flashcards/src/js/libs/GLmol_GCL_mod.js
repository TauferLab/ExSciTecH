...
var GLmol = (function() {
    ...
    GLmol.prototype.drawBondAsStickSub = function(group, atom1, atom2, bondR, order) {    
        ...
        if (order > 1) {
            ...
            this.drawCylinder(group, p1.clone().addSelf(delta), mp, bondR, atom1.color);
            this.drawCylinder(group, p2.clone().addSelf(delta), mp, bondR, atom2.color);
            tmp = mp.clone().subSelf(delta);
            this.drawCylinder(group, p1.clone().subSelf(delta), mp, bondR, atom1.color);
            this.drawCylinder(group, p2.clone().subSelf(delta), mp, bondR, atom2.color);
        }
    };
