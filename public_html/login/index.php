...
<html>
	...
	<link rel="stylesheet" type="text/css" href="/login/src/css/Login.css" />
    ...
    <body>
        			    ...
        			    <div class="panel panel-default" id="loginWrapper">
            				<div class="panel-body" id="loginArea">
            				    ...
            				    <form id="loginForm" class="form-horizontal" action="/">
                    				<input class='form-control' id="loginEmail" placeholder="Email or Username" type="text" required="required"\>
                    				<input class='form-control' id="loginPass" placeholder="Password" type="password" required="required"\>
                    				<input type="submit" id="loginBtn" type="button" class="btn btn-success" value="Login!">
            				    </form>
        			    ...
        			    <div class="panel panel-default" id="regWrapper">
            				<div class="panel-body" id="regArea">
            				    ...
            				    <form class="form-horizontal" action="" onsubmit="return false;">
                    				...
                    				<input type="submit" id="regBtn" type="button" class="btn btn-success" value="Register!">
            				    </form>
        ...
        <script type="text/javascript" src="/login/src/js/login.js"></script>
